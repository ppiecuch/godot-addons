...
export(String, FILE, "*.ini") var DEFAULT_OPTIONS_PATH: String = "res://addons/autoload/basic/user_options.ini" #Next to this file.
export(String, FILE, "*.ini") var USER_OPTIONS_PATH: String = "user://user_options.ini"
